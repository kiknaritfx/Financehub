...
table.items{width:100%;border-collapse:collapse;margin:0;border:1.5px solid #334155;}
table.items thead tr{background:#1e293b;}
table.items thead th{color:#fff;padding:9px 14px;font-size:12px;font-weight:700;text-align:left;border-right:1.5px solid #475569;}
table.items thead th:last-child{text-align:right;border-right:none;}
table.items tbody td{padding:8px 14px;font-size:12px;border:1px solid #334155;background:#fff;}
table.items tbody td.num{text-align:right;font-weight:600;}
tr.sub-row td{background:#f1f5f9!important;font-weight:700;}
tr.wht-row td{color:#dc2626;background:#fff5f5!important;}
tr.wht-row td.num{color:#dc2626;}
tr.net-row td{background:#1e293b!important;color:#fff;font-weight:800;font-size:14px;}
